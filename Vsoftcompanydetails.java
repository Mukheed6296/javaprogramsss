package Projectforassign;

public class Vsoftcompanydetails {

    public static void main(String[] args) {

        Employee m2 = new Employee("Umakanth", "EM027","Manager");
        Employee ad1 = new Employee("Srihari", "EM001","ADMIN");
        Employee ad2 = new Employee("Vishal", "EM002","ADMIN");
        Employee ad3= new Employee("Srikar", "EM003","ADMIN");
        ...
        Employee d2 = new Employee("Md Mukheed", "EM005","Developer");
        ...
        Employee d6= new Employee("Naveen", "EM009","Developer");
        Employee[] awsdv={m4,d5,d6};

        Employee m6 = new Employee("Roopaly", "EM076","HR Manager");
        Employee hr1 = new Employee("Elizibeth", "EM012", "HR");
        Employee hr2= new Employee("Sumitra", "EM013", "HR");
        Employee hr3= new Employee("Ramachandra", "EM014", "HR");
        Employee[] hrs={m6,hr1,hr2,hr3};

        Employee m3 = new Employee("Raja Shekhar", "EM037","Manager");
        Employee d3 = new Employee("Praveen", "EM006","Developer");
        Employee d4= new Employee("Trinath", "EM007","Developer");
        ...
        Employee d10= new Employee("Akhila", "EM055","Developer");
        Employee[] servicenowdv={m7,d9,d10};


        Employee m5 = new Employee("Srinivas Pabba", "EM065","Manager");
        Employee d7= new Employee("Hareesh", "EM010","Developer");
        Employee d8= new Employee("Eshwar", "EM011","Developer");
